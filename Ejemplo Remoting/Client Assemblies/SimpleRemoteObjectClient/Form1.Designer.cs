namespace SimpleRemoteObjectClient
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			// button2
			// 
			this.button2.Location = new System.Drawing.Point(333, 325);
			...
			// bindingSource1
			// 
			this.bindingSource1.DataSource = typeof(SimpleRemoteObjectClient.MyClass);
			// 
			// listBox1
			// 
			this.listBox1.FormattingEnabled = true;
			this.listBox1.Location = new System.Drawing.Point(245, 151);
